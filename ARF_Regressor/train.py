...
TARGET_COLUMN = "vinn"                                                  #Output 
FEATURE_COLUMNS = ["pd", "vinp", "vdd", "process", "temperature"]       #input
...
print("Model training and Incremental Learning training started..")
